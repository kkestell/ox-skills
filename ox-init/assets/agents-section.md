...
- `/ox-review` reviews code, fixes findings that have obvious fixes, writes a review to `docs/agents/reviews/`, records the remaining findings in `docs/agents/issues.csv`, checks off the reviewed task in `docs/agents/todo.md`, and commits.
